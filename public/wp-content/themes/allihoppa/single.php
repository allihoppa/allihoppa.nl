                ...
                <div class="entry">
                    ...
                    <div class="social_share_wrap">
                        <div class="social_share">
                            <a href="http://www.facebook.com/share.php?u=<?php print(urlencode(get_permalink())); ?>&title=<?php print(urlencode(the_title())); ?>"
                               class="btn_social facebook">&nbsp;</a>
                            <a href="http://twitter.com/home?status=<?php print(urlencode(get_permalink())); ?>+<?php print(urlencode(the_title())); ?>"
                               class="btn_social twitter">&nbsp;</a>
                            <a href="http://www.pinterest.com/pin/create/button/?url=<?php the_permalink(); ?>&media=<?php if (function_exists('the_post_thumbnail')) echo wp_get_attachment_url(get_post_thumbnail_id()); ?>&description=<?php echo get_the_title(); ?>"
                               class="btn_social pinterest">&nbsp;</a>
                        </div>
                    </div>
