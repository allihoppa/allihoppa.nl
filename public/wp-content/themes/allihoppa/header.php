...
<link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/css/animated_items.css" type="text/css" media="screen" />
<?php if(is_single()) { ?>
...
<link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/css/browserfixes.css" type="text/css" media="screen" />
<![endif]-->
...
<script type="text/javascript">
	$(function() {	preload_images(<?php echo $site_images; ?>); });
</script>
...
#header .menu, #footer_copy { background: #<?php echo $category_color; ?>; }
#backtohome, #footer_logo a, .footer_line, a.btn_social { background-color: #<?php echo $category_color; ?>; }
#header .catmenu { border-top: 1px solid #<?php echo $category_color; ?>;	border-bottom: 1px solid #<?php echo $category_color; ?>; }
.entry_head {	border-bottom: 1px solid  #<?php echo $category_color; ?>;  }
.content_left {	border-right: 1px solid #<?php echo $category_color; ?>;  }
a:link, a:visited, #header .catmenu, .item_type, h1, h2, h3, h4, h5, h6, .footer, .postfilter { color: #<?php echo $category_color; ?>; }
#search_field { border: 1px solid #<?php echo $category_color; ?>;  }
</style>
